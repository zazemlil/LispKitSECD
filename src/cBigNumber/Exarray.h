/* --------------------------------------------------------------
    Динамические массивы с проверкой индекса (версия 2.0).

    http://www.imach.uran.ru/exarray

    Copyright 1998-2025, Р.Н.Шакиров, ИМаш УрО PAH.
    All Rights Reserved.
...
template <class T> void exblockstack<T>::get (exblock<T>& array)
{
    ...
    {                                   /* создание массива */
        array.setbase_c (exblock<T>::stub());
        array.setsize_c (0);
    }
}
/*
